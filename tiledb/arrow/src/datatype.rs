...
pub mod tests {
    ...
    pub fn arbitrary_arrow_invertible(
    ...
    pub fn arbitrary_arrow_implemented(
        ...
        tiledb_test::datatype::arbitrary_implemented()
    ...
    mod strategy {
        ...
        proptest! {
            ...
            #[test]
            fn test_arbitrary_arrow_invertible_to_tiledb(arrow_dt_in in arbitrary_arrow_invertible()) {
