...
use tiledb::query::buffer::WriteBufferCollection;
use tiledb::query::traits::QueryBuilder;
use tiledb::query::write::WriteQueryBuilder;
use tiledb::query::QueryLayout;
use tiledb::Result as TileDBResult;

const ARRAY_URI: &str = "fragment_info_example_array";
...
fn read_fragment_info() -> TileDBResult<()> {
    ...
    let frag_infos =
        tiledb::array::FragmentInfoBuilder::new(&tdb, ARRAY_URI)?.build()?;
